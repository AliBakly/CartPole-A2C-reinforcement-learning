...
# Set hyperparameters
def train(lr_actor, lr_critic, gamma, K, n, env_name, continous, log_interval, eval_interval, num_eval_episodes, max_steps, prob_mask):
    ...
    plot_result(train_return_history, 'Time Step', 'Average Return', 'Return during Training')
    plot_result(eval_return_history, 'Time Step', 'Average Return', 'Return during Evaluation')
    plot_result(train_loss_critic_history, 'Time Step', 'Loss', 'Loss of Critic during Training')
    plot_result(train_loss_actor_history, 'Time Step', 'Loss', 'Loss of Actor during Training')
